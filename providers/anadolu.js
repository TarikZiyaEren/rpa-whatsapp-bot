...
class AnadoluProvider extends BaseProvider {
  constructor(credentials = {}) {
    super(credentials);
    this.name = "Anadolu Sigorta";
  }
  ...
  get loginUrl() {
    return process.env.ANADOLU_SIGORTA_URL
