...
class AllianzProvider extends BaseProvider {
  get providerName() { return "Allianz"; }
  get loginUrl() {
  ...
  async doLogin() {
    this.progress("Allianz: Login sayfasına gidiliyor...");
    ...
    this.progress("Allianz: Giriş başarılı.");
  }

  async doProvizyon(data) {
    this.progress("Allianz: Form dolduruluyor...");
    ...
    // DÜZELTME: RED durumunda "div.box.err" geliyor, sadece "div.box.ok" beklemek timeout'a neden oluyordu
    ...
    return { provider: "Allianz", durum, ham: text, islem: data.islem };
  }
}

module.exports = AllianzProvider;